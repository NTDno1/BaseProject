...
namespace DemoCICD.Persistance.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfBirthi = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDirectorr = table.Column<bool>(type: "bit", nullable: true, defaultValue: false),
                    IsHeadOfDepartment = table.Column<bool>(type: "bit", nullable: true, defaultValue: false),
                    MangerID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    PositionID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsRecepitient = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FuntionID = table.Column<string>(type: "nvarchar(50)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActionInFunctions", x => new { x.ActionId, x.FuntionID });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActionInFunctions_Functions_FuntionID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActionInFunctions_FuntionID",
